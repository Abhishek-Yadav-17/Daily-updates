...
public class implement_strstr_20240126 {
     ...
     *                  In the worst case, we iterate through almost the entire haystack for each possible starting position.
     *
     * Space Complexity: O(1). We use only constant extra space.  The substring operation creates a new string, but its size is bounded by the length of the needle, which is considered constant extra space with respect to the input.
     */
}
